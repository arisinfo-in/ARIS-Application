...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const { moduleId, category, limit = 8 } = params;
...
async function generateNewsArticles(apiKey, moduleId, category, limit) {
  try {
...
function createNewsPrompt(moduleId, category, limit) {
...
function getMockNewsData(moduleId, limit = 3) {
  const mockArticles = [
    {
      id: 'mock_1',
